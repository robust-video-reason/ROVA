...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node="4" \
    ...
    --master_port="12365" \
    src/open_r1/grpo_memory.py \
    --output_dir "/path/to/data/log/Qwen2.5-VL-7B-GRPO" \
    --model_name_or_path 'Qwen/Qwen2.5-VL-7B-Instruct' \
    --dataset_name "/path/to/data/data/train-2k.json" \
    ...
    --max_memory_size 100 \
    --memory_file /path/to/data/log/insufficient_samples_memory.json \

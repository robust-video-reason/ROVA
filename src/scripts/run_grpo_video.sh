...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node="4" \
    ...
    --master_port="12365" \
    src/open_r1/grpo.py \
    --output_dir "/path/to/data/log/Qwen2.5-VL-7B-GRPO-VSI" \
    --model_name_or_path '/path/to/project/src/r1-v/log/Qwen2.5-VL-7B-cot-sft/checkpoint-125' \
    --dataset_name "/path/to/data/VSIBench/grpo_2k.json" \
